...
class _OperaEmailClient(unittest.TestCase):
    ...
    def test_get_emails_for_from_addressees_01(self):
        ...
        self.assertEqual(
            oec.get_emails(),
            oec._get_emails_for_from_addressees())
    ...
    def test_get_emails_for_from_addressees_02(self):
        ...
        self.assertGreaterEqual(
            len(oec.get_emails()),
            len(oec._get_emails_for_from_addressees()))
...
class _OperaEmailClient_copy(unittest.TestCase):
    ...
    def test_copy_emails_to_directory_01(self):
        ...
        exist1, equal1, copied1, changed1, exclude1 = oec.copy_emails_to_directory()
        ...
        exist2, equal2, copied2, changed2, exclude2 = oec.copy_emails_to_directory()
        ...
        exist3, equal3, copied3, changed3, exclude3 = oec.copy_emails_to_directory()
        ...
        exist4, equal4, copied4, changed4, exclude4 = oec.copy_emails_to_directory()
...
class EmailCollector(unittest.TestCase):
    ...
    def test__assumptions(self):
        ...
        self.assertEqual(
            emailcollector._OPERA_EMAIL_CLIENT, 'opera', msg=msg)
